...
private:
    ...
    static constexpr float spindashTopSpeed = 5.0;
    static constexpr float spindashMinSpeed = 1.5;
    static constexpr float spindashDecay = 0.02;
    static constexpr float spindashMaxCharge = 4.0;
    ...
    TA_Links links;
    TA_Rect hitbox, hammerHitbox, spindashHitbox;
    ...
    float spindashSpeed = 0;
    int spindashRevs = 0;
    bool spindashCharging = false;
    TA_Sound spindashRevSound, spindashGoSound;
...
public:
    ...
    TA_Rect* getSpindashHitbox() { return &spindashHitbox; }
    ...
    bool isSpindashing() { return state == STATE_SPINDASH; }
